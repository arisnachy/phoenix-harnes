...
import { parseSessionLog } from '@phoenix-ai/dsh-llm-replay'
import type { SessionEvent, SessionId } from '@phoenix-ai/dsh-session'
import type {} from '@phoenix-ai/dsh-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@phoenix-ai/dsh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@phoenix-ai/dsh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@phoenix-ai/dsh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@phoenix-ai/dsh-skill-filesystem"}\n',
