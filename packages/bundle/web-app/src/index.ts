/**
 * @phoenix-ai/dsh-web-app — the browser-surface bundle's runtime glue plugin
...
function resolveDistIndex(): string {
  ...
  try {
    return require.resolve('@phoenix-ai/dsh-web-frontend/dist/index.html')
  } catch {
  ...
  if (config.surfaceContext) {
    ...
    ctx.inject(['shellEnv'], (runtimeCtx) => {
      runtimeCtx.shellEnv.register({
        name: 'web-runtime',
        variables: {
          [DSH_WEB_URL]: { description: 'Canonical local URL of the PHOENIX Web GUI serving this session.' },
        },
