...
export const Config = z.union([
  z.object({
    ...
    serverName: commonConfigFields.serverName,
    toolCallTimeoutMs: commonConfigFields.toolCallTimeoutMs,
    failOnStartupError: commonConfigFields.failOnStartupError,
    startupTimeoutMs: commonConfigFields.startupTimeoutMs,
    reconnect: commonConfigFields.reconnect,
