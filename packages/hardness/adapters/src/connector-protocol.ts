...
- Only after connector_list confirms the needed capability is absent — or returns has_relevant_match=false for the named target — use connector_discover against the Official MCP Registry. Never substitute a different disconnected connector for the requested one.
