...
- When a decision materially depends on a missing/stale field, verify it with the appropriate live capability before acting. If the capability is absent, say the fact is unavailable instead of fabricating it.
