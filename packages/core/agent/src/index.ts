...
import type { TypertContext, TypertLookup } from '@phoenix-ai/dsh-typert-protocol'
 ...
 * (`@phoenix-ai/dsh-agent-loop`), registered via {@link setFactory}.
 *
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('agent', {
        parameter: 'agent',
        wire: 'agentId',
        hostTypeSymbol: '@phoenix-ai/dsh-agent#Agent',
