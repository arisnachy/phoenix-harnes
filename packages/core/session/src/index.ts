...
import type { TypertLookup } from '@phoenix-ai/dsh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@phoenix-ai/dsh-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@phoenix-ai/dsh-session#Session',
        wireTypeSymbol: '@phoenix-ai/dsh-session/types#SessionId',
