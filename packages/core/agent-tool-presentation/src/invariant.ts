/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-agent-tool-presentation`.
 * @module @phoenix-ai/dsh-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-agent-tool-presentation'
