/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-session-query-sqlite`.
 * @module @phoenix-ai/dsh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-session-query-sqlite'
