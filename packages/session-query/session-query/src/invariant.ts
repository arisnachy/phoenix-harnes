/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-session-query`.
 * @module @phoenix-ai/dsh-session-query/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-session-query'
