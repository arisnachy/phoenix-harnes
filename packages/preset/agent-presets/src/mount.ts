 ...
 * @module @phoenix-ai/dsh-agent-presets/mount
 */
...
import type { EntryTree } from '@phoenix-ai/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@phoenix-ai/dsh-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@phoenix-ai/dsh-*` row would fail to import. The
