 ...
 * @module @phoenix-ai/dsh-sandbox-local
 */
...
} from '@phoenix-ai/node-addon-landlock-run'
import { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { assertNever } from '@phoenix-ai/dsh-llm'
import { SandboxProvider, SandboxUnavailableError } from '@phoenix-ai/dsh-sandbox'
import type { ConfinedArgv, ConfinedSandboxMode, RunnerFailureRule, SandboxEnforcement, SandboxPolicy } from '@phoenix-ai/dsh-sandbox'
import type { SessionId } from '@phoenix-ai/dsh-session'
import { AclWriteGrant, assertTempRootOutsideWorkspace, tempWriteSid, workspaceWriteSid } from '@phoenix-ai/dsh-sandbox-windows-acl'
...
const PLATFORM_CHAINS: Record<string, readonly SelectedRunner['runner'][]> = {
  ...
  darwin: ['seatbelt'],
  // The Windows restricted-token runner (@phoenix-ai/dsh-sandbox-windows-acl):
