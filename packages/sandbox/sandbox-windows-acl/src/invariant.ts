/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-sandbox-windows-acl`.
 * @module @phoenix-ai/dsh-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-sandbox-windows-acl'
