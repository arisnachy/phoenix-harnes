/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-cordis-host-runner`.
 * @module @phoenix-ai/dsh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-cordis-host-runner'
