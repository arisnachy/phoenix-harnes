/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-cordis-client-runner`.
 * @module @phoenix-ai/dsh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-cordis-client-runner'
