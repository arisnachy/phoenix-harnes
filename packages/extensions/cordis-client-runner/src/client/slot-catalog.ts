...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    key: 'capability.surface.preview',
    kind: 'list',
    scope: 'root',
    summary: 'Declarative, non-executing capability preview entries.',
    doc: 'Declarative, non-executing capability preview entries.',
    registerOptions: [
      {
        name: 'id',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'capability.surface.preview\', () => ctx.slots.register(\n      { name: \'capability.surface.preview\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Whole center conversation surface.',
    doc: 'Whole center conversation surface.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, context, hardness-artifact, manual-compaction, model-retry, steering, tool-call, turn-error, turn-max-tokens, turn-tail, unknown, user, workflow-run',
    hookContext: 'string',
    ...
    occupants: [
      ...
      'client-ui-conversation HardnessArtifactNodeView key \'hardness-artifact\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-brand-official PhoenixBrandMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-subagent CompletionAwareSubagentHeaderLineage',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'Ordinary session details column.',
    doc: 'Ordinary session details column.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'True floating frame layer.',
    doc: 'True floating frame layer. Entries here never reserve conversation space.\nToasts, badges and transient overlays belong here.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-kira-teams KiraTeamsDock id \'kira-teams\'',
      'client-ui-workspace () => createElement(CordisVisualWorkspace, { controller: … id \'cordis-visual-workspace\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'shell.workspace\', () => ctx.slots.register(\n      { name: \'shell.workspace\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Whole left navigation column.',
    doc: 'Whole left navigation column.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-brand-official PhoenixBrandName',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-settings-plugin-inventory UpdateFooterAction id \'phoenix-update\'',
