...
import type { SessionId } from '@phoenix-ai/dsh-client-connection/client'
import type { DynamicCordisInvokeResult } from '@phoenix-ai/dsh-api-remotes/client'
// Type-only: resolves `ctx.remote` and with it the `$on`/`$dispatch` surface.
import type {} from '@phoenix-ai/dsh-api-gateway/client'
