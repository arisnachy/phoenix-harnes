/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-cordis`.
 * @module @phoenix-ai/dsh-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-cordis'
