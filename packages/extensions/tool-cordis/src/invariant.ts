/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-tool-cordis`.
 * @module @phoenix-ai/dsh-tool-cordis/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-tool-cordis'
