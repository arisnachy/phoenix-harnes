...
|---|---|---|
| [`agent-spine-demo/`](agent-spine-demo/README.md) | `@phoenix-ai/dsh-agent-spine-demo` | Reusable agent-spine bundle |
| [`acp-demo/`](acp-demo/README.md) | `@phoenix-ai/dsh-acp-demo` | ACP automation application bundle |
| [`jsonrpc-demo/`](jsonrpc-demo/README.md) | `@phoenix-ai/dsh-sdk-jsonrpc-demo` | External-config JSON-RPC runtime |
