/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-sdk-jsonrpc-demo`.
 * @module @phoenix-ai/dsh-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-sdk-jsonrpc-demo'
