...
import SystemPrompt, { type Config as SystemPromptConfig } from '@phoenix-ai/dsh-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@phoenix-ai/dsh-tools'
import SkillRegistry, { type Config as SkillRegistryConfig } from '@phoenix-ai/dsh-skill'
import * as SkillFileSystem from '@phoenix-ai/dsh-skill-filesystem'
import AgentRegistry from '@phoenix-ai/dsh-agent'
import GoalService, { type Config as GoalDomainConfig } from '@phoenix-ai/dsh-goal'
import * as goalSession from '@phoenix-ai/dsh-goal-round-driver'
import * as toolGoal from '@phoenix-ai/dsh-tool-goal'
import LocalJobRegistry, { type Config as JobsConfig } from '@phoenix-ai/dsh-jobs-local'
import InvariantRegistry, { type Config as InvariantConfig } from '@phoenix-ai/dsh-invariants'
...
import * as scopeInvariant from '@phoenix-ai/dsh-scope/invariant'
import * as agentLoopInvariant from '@phoenix-ai/dsh-agent-loop/invariant'
import * as toolBash from '@phoenix-ai/dsh-tool-bash'
import * as bashEnv from '@phoenix-ai/dsh-shell-env'
import * as workspaceContext from '@phoenix-ai/dsh-agent-instructions'
import * as toolSkill from '@phoenix-ai/dsh-tool-skill'
import * as toolJobs from '@phoenix-ai/dsh-tool-jobs'
import AgentLoop, { type Config as AgentLoopConfig } from '@phoenix-ai/dsh-agent-loop'
import * as llmRetry from '@phoenix-ai/dsh-llm-retry'
...
export interface Config {
  ...
  tools?: ToolsConfig
  /** PHOENIX home directory shared by shell context and local skill discovery. */
  dshHome?: string
