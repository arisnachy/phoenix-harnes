/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-agent-spine-demo`.
 * @module @phoenix-ai/dsh-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-agent-spine-demo'
