/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-typert-registry`.
 * @module @phoenix-ai/dsh-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-typert-registry'
