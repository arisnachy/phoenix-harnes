/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-typert-generator`.
 * @module @phoenix-ai/dsh-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-typert-generator'
