/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-typert-loader`.
 * @module @phoenix-ai/dsh-typert-loader/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-typert-loader'
