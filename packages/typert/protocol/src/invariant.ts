/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-typert-protocol`.
 * @module @phoenix-ai/dsh-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-typert-protocol'
