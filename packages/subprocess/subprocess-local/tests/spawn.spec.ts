...
import type { SubprocessHandle, SubprocessOutputReader } from '@phoenix-ai/dsh-subprocess'
...
describe('environment and spill-file hardening', () => {
  it('scrubs credential-shaped and ambient PHOENIX env vars from child processes', async () => {
