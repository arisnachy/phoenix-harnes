...
import LlmRuntime, { createUserMessage, LlmAdapter, LlmError, resolveRetryPolicy  } from '@phoenix-ai/dsh-llm'
import type { GenerateOptions, ResolvedRetryPolicy, StreamChunk } from '@phoenix-ai/dsh-llm'
...
async function loadYaml(lines: readonly string[]): Promise<Context> {
  ...
  const modules = new Map<string, unknown>([
    ['@phoenix-ai/dsh-llm', LlmRuntime],
    ['@phoenix-ai/dsh-session', SessionStore],
    ['@phoenix-ai/dsh-system-prompt', SystemPrompt],
    ['@phoenix-ai/dsh-tools', ToolRuntime],
    ['@phoenix-ai/dsh-agent', AgentRegistry],
    ['@phoenix-ai/dsh-llm-retry', retry],
    ['@phoenix-ai/dsh-agent-loop', AgentLoop],
  ])
