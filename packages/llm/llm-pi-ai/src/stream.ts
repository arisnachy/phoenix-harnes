...
import { CallId, CONTEXT_WINDOW_EXCEEDED_CODE, EMPTY_RESPONSE_CODE, isContextWindowExceededError, isQuotaExceededError, LlmError, QUOTA_EXCEEDED_CODE } from '@phoenix-ai/dsh-llm'
import type { FinishReason, StreamChunk, TokenUsage } from '@phoenix-ai/dsh-llm'
 ...
 * @param desiredMaxOutput - original intended output budget before provider/context clamping.
 ...
 * @param contextWindow - resolved catalog capacity for usage-based overflow detection.
 * @param desiredMaxOutput - original intended output budget used to classify early length stops.
