/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-token-meter`.
 * @module @phoenix-ai/dsh-token-meter/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-token-meter'
