/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-agent-loop-testkit`.
 * @module @phoenix-ai/dsh-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-agent-loop-testkit'
