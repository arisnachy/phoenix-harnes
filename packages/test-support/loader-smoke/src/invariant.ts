/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-loader-smoke`.
 * @module @phoenix-ai/dsh-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-loader-smoke'
