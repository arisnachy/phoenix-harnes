/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-acp-snapshot`.
 * @module @phoenix-ai/dsh-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-acp-snapshot'
