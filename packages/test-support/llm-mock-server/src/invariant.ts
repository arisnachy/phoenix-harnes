/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-llm-mock-server`.
 * @module @phoenix-ai/dsh-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-llm-mock-server'
