/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-test-runtime`.
 * @module @phoenix-ai/dsh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-test-runtime'
