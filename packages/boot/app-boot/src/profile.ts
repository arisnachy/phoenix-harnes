 ...
 * @module @phoenix-ai/dsh-app-boot/profile
 */
...
export const PROFILE_TEMPLATES: Record<string, readonly string[]> = {
  web: ['@phoenix-ai/dsh-base', '@phoenix-ai/dsh-web-app'],
...
export const DEFAULT_PROFILE_BUNDLES: readonly string[] = ['@phoenix-ai/dsh-base']
 ...
 * `@phoenix-ai/dsh-base` (and every other in-box bundle) always comes from
