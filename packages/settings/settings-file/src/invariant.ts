/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-settings-file`.
 * @module @phoenix-ai/dsh-settings-file/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-settings-file'
 ...
 * tests; the in-process commit relation is owned by `@phoenix-ai/dsh-settings`.
 */
