/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-session-telemetry`.
 * @module @phoenix-ai/dsh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-session-telemetry'
