/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-session-telemetry-otel`.
 * @module @phoenix-ai/dsh-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-session-telemetry-otel'
