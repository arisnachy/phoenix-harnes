/**
 * OpenTelemetry Service Provider for the PHOENIX telemetry capability.
 *
 ...
 *
 * @module @phoenix-ai/dsh-session-telemetry-otel
 */
...
} from '@phoenix-ai/dsh-session-telemetry'
import { APP_IDENTITY } from '@phoenix-ai/dsh-llm'
import { getOrCreateAnonymousUserId } from '@phoenix-ai/dsh-anonymous-user-id'
import {
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@phoenix-ai/dsh-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@phoenix-ai/dsh-session-telemetry-otel/ops', version)
