/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-session-projection`.
 * @module @phoenix-ai/dsh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-session-projection'
