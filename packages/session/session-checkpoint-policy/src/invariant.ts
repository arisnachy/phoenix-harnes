/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-session-checkpoint-policy`.
 * @module @phoenix-ai/dsh-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-session-checkpoint-policy'
