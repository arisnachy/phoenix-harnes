/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-session-persistence-sqlite`.
 * @module @phoenix-ai/dsh-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-session-persistence-sqlite'
