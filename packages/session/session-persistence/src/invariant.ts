/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-session-persistence`.
 * @module @phoenix-ai/dsh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-session-persistence'
