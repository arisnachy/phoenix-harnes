/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-session-title-first-prompt-llm`.
 * @module @phoenix-ai/dsh-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-session-title-first-prompt-llm'
