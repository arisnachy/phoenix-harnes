...
import LlmRuntime, { createUserMessage, LlmAdapter  } from '@phoenix-ai/dsh-llm'
...
import * as providerPlugin from '@phoenix-ai/dsh-session-title-first-prompt-llm'
...
async function loadComposition(): Promise<Context> {
  ...
  await writeFile(configPath, [
    ...
    "- name: '@phoenix-ai/dsh-session-title'",
    '  config:',
    '    fallbackMaxWords: 5',
    '    fallbackMaxBytes: 40',
    '    maxTitleBytes: 80',
    "- name: '@phoenix-ai/dsh-session-title-first-prompt-llm'",
    '  config:',
    '    targetWords: 5',
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@phoenix-ai/dsh-session-title', SessionTitleService],
    ['@phoenix-ai/dsh-session-title-first-prompt-llm', providerPlugin],
  ])
