/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-session-stats`.
 * @module @phoenix-ai/dsh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-session-stats'
