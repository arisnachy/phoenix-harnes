/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-session-projection-cache`.
 * @module @phoenix-ai/dsh-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-session-projection-cache'
