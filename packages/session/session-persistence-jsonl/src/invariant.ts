/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-session-persistence-jsonl`.
 * @module @phoenix-ai/dsh-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-session-persistence-jsonl'
