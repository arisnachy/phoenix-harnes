/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-session-title`.
 * @module @phoenix-ai/dsh-session-title/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-session-title'
