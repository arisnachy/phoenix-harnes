/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-anonymous-user-id`.
 * @module @phoenix-ai/dsh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-anonymous-user-id'
