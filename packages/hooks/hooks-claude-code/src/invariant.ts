/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-hooks-claude-code`.
 * @module @phoenix-ai/dsh-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-hooks-claude-code'
