/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-tool-call-timeout-policy`.
 * @module @phoenix-ai/dsh-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-tool-call-timeout-policy'
