/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-repeat-tool-reminder`.
 * @module @phoenix-ai/dsh-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-repeat-tool-reminder'
