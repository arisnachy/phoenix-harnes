/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-code-runtime-worker-thread`.
 * @module @phoenix-ai/dsh-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-code-runtime-worker-thread'
