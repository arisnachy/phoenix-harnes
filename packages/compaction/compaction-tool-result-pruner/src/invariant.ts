/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-compaction-tool-result-pruner`.
 * @module @phoenix-ai/dsh-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-compaction-tool-result-pruner'
