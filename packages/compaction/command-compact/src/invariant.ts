/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-command-compact`.
 * @module @phoenix-ai/dsh-command-compact/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-command-compact'
