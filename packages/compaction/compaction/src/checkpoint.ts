 ...
 *
 * The seam itself lives in `@phoenix-ai/dsh-compaction`, which re-exports these
 ...
 *
 * @module @phoenix-ai/dsh-compaction/checkpoint
 */

import type { MessageSource } from '@phoenix-ai/dsh-llm/message'
