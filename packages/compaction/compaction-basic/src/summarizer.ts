...
const COMPACTION_INSTRUCTION = [
  'You are now acting as a compaction engine for this AI coding assistant. Condense the conversation ABOVE into a small structured checkpoint that lets another model resume the work without replaying the full history.',
  '',
  'Output EXACTLY the Markdown structure below: keep every section, in order. Use terse bullets, not prose paragraphs. Write "(none)" for an empty section — never drop a section.',
  '',
  '## Objective',
  "- [the user's original and evolving goals; quote verbatim only where exact wording matters]",
  '',
  '## Files',
  '- [exact path: why it matters and the current relevant change/state]',
  '',
  '## Decisions',
  '- [accepted architectural/implementation decisions, constraints, and why they matter]',
  '',
  '## Evidence',
  '- [tests, commands, observed failures/fixes, measurements, and verified results]',
  '',
  '## Pending',
  '- [explicit work not yet completed, blockers, or unresolved questions]',
  '',
  '## Current Work',
  '- [precisely what was in progress at this checkpoint]',
  '',
  '## Next Step',
  '- [the single next action aligned with the latest request, or "(none)"]',
  '',
  '## Critical Context',
  '- [only additional facts required to continue safely: identifiers, user corrections/preferences, dependencies, or technical concepts]',
  '',
  'Rules:',
  '- Write concise English engineering prose. Preserve exact file paths, commands, error strings, identifiers, numeric values, function signatures, and syntax fragments.',
  '- Keep evidence and decisions; drop redundant narration, raw JSON/tool dumps, stale alternatives, and details that do not affect continuation.',
  '- Capture user feedback and explicit instructions faithfully, especially corrections.',
  '- Do NOT mention this summarization request or that the context was compacted.',
  '- Output only the checkpoint text: do not call any tool or take any other action.',
  `- If the conversation already contains a ${SUMMARY_OPEN_TAG} block, it is a PRIOR checkpoint. Do not copy it forward verbatim: preserve still-true facts, drop stale ones, and merge newer information into one checkpoint under the same structure.`,
].join('\n')
