...
import * as GoalSessionInvariant from '@phoenix-ai/dsh-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@phoenix-ai/dsh-goal-round-driver'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@phoenix-ai/dsh-goal-round-driver',
    }))
  })
