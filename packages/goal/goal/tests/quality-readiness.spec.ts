...
import { qualityReadiness, type QualityAssessmentSnapshot } from '../src/quality.ts'
...
describe('qualityReadiness', () => {
  ...
  test('rejects an unresolved high-severity scenario', () => {
    ...
    snapshot.scenarios[0] = { ...scenario, status: 'untested', blocker: 'provider offline' }
  ...
  test('never treats an innovation as compensation for an unmet requested criterion', () => {
    ...
    snapshot.criteria[0] = { ...criterion, status: 'failed' }
