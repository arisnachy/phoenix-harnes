...
import SessionStore, { Session, SessionId, type UserMessage } from '@phoenix-ai/dsh-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
...
function stubAgent(rawId: string, seed?: readonly import('@phoenix-ai/dsh-session').SessionEvent[]): StubAgent {
