/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-command-goal`.
 * @module @phoenix-ai/dsh-command-goal/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-command-goal'
