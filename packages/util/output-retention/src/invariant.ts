/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-output-retention`.
 * @module @phoenix-ai/dsh-output-retention/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-output-retention'
