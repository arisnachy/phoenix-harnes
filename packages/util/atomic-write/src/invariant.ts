/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-atomic-write`.
 * @module @phoenix-ai/dsh-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-atomic-write'
