/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-native-command`.
 * @module @phoenix-ai/dsh-native-command/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-native-command'
