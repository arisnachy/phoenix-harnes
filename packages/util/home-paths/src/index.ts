...
/** Directory name for the default PHOENIX home under the OS home. */
export const DSH_HOME_DIR_NAME = '.dsh'

/** Stable user-facing display form for the default PHOENIX home. */
export const DEFAULT_DSH_HOME_DISPLAY = `~/${DSH_HOME_DIR_NAME}`

/** Environment variable that overrides the default PHOENIX home. */
...
/**
 * Resolve the default PHOENIX home using Node's platform path rules.
...
/**
 * Resolve the single-root PHOENIX home.
 *
...
/**
 * Join path segments onto the resolved PHOENIX home.
