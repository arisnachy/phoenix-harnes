/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-launch-environment`.
 * @module @phoenix-ai/dsh-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-launch-environment'
