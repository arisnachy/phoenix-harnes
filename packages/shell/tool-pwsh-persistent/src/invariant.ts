/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-tool-pwsh-persistent`.
 * @module @phoenix-ai/dsh-tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-tool-pwsh-persistent'
