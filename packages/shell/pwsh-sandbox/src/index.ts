 ...
 * `@phoenix-ai/dsh-bash-sandbox`. It wraps the exact local pwsh argv through
 ...
 * renders.
 * @module @phoenix-ai/dsh-pwsh-sandbox
 */
 ...
 * on `ctx.sandboxPolicy` (`@phoenix-ai/dsh-sandbox-policy`), which resolves
