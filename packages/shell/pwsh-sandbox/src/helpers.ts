 ...
 * mirror of `@phoenix-ai/dsh-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @phoenix-ai/dsh-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@phoenix-ai/dsh-shell'
import type { RunnerFailureRule } from '@phoenix-ai/dsh-sandbox'
