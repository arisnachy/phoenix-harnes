...
import { seatbeltProfileArgs } from '@phoenix-ai/dsh-sandbox-local/src/profiles.ts'
 ...
 * confinement is covered by `@phoenix-ai/dsh-sandbox-local`. Skips off macOS or when
