/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-tool-bash-persistent`.
 * @module @phoenix-ai/dsh-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-tool-bash-persistent'
