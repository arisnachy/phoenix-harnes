/**
 * Real-process tests for `@phoenix-ai/dsh-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@phoenix-ai/dsh-pwsh-local'
...
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@phoenix-ai/dsh-subprocess'
import { MAX_TIMER_DELAY_MS } from '@phoenix-ai/dsh-timeout'
import type { ShellProcess } from '@phoenix-ai/dsh-shell'
