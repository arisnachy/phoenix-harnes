/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-tool-subagent-control`.
 * @module @phoenix-ai/dsh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-tool-subagent-control'
