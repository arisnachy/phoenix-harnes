/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-tool-subagent`.
 * @module @phoenix-ai/dsh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-tool-subagent'
