/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-tool-subagent-report`.
 * @module @phoenix-ai/dsh-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-tool-subagent-report'
