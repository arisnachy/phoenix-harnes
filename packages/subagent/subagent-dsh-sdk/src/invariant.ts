/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-subagent-dsh-sdk`.
 * @module @phoenix-ai/dsh-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-subagent-dsh-sdk'
