/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-subagent-codex`.
 * @module @phoenix-ai/dsh-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-subagent-codex'
