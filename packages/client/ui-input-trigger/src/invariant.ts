/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-input-trigger`.
 * @module @phoenix-ai/dsh-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-input-trigger'
