/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-directory-picker-browse`.
 * @module @phoenix-ai/dsh-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-directory-picker-browse'
