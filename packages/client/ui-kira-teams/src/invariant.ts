/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-client-ui-kira-teams`.
 * @module @deepseek-ai/dsh-client-ui-kira-teams/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-client-ui-kira-teams'
