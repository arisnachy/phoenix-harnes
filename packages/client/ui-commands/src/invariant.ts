/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-commands`.
 * @module @phoenix-ai/dsh-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-commands'
