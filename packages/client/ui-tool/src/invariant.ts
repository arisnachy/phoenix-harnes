/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-tool`.
 * @module @phoenix-ai/dsh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-tool'
