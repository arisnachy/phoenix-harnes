...
import type { ToolResultView } from '@phoenix-ai/dsh-api-remotes/client'
import { bindSnapshotSelector } from '@phoenix-ai/dsh-client-test-runtime'
import type { SelectionTarget } from '@phoenix-ai/dsh-client-ui-conversation/client'
import type { ToolCallOwnerProps } from '@phoenix-ai/dsh-client-ui-tool/client'
import { IconGlobeOutline14 } from '@phoenix-ai/dsh-client-ui-primitives'
...
import { DetailsPanel } from '@phoenix-ai/dsh-client-ui-conversation/src/client/skeleton/DetailsPanel.tsx'
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@phoenix-ai/cordis').Context
