...
import type { SessionProviderComponent, TranslateNS } from '@phoenix-ai/dsh-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@phoenix-ai/dsh-client-ui-conversation/src/client/contract/slots.ts'
