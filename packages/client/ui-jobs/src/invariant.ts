/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-jobs`.
 * @module @phoenix-ai/dsh-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-jobs'
