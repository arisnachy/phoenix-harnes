/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-settings-models`.
 * @module @phoenix-ai/dsh-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-settings-models'
