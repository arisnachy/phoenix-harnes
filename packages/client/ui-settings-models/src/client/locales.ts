...
export const en = {
  ...
  onboardingDescription: 'Connect ChatGPT / Codex first, or use an API key if you prefer another model provider.',
  onboardingCodex: 'Continue with ChatGPT / Codex',
  onboardingFinishing: 'Preparing PHOENIX…',
  onboardingUseApiKey: 'Use an API key instead',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  onboardingDescription: '优先连接 ChatGPT / Codex；如果你更喜欢其他模型提供方，也可以使用 API 密钥。',
  onboardingCodex: '使用 ChatGPT / Codex 继续',
  onboardingFinishing: '正在准备 PHOENIX…',
  onboardingUseApiKey: '改用 API 密钥',
...
export const es: { [Key in keyof typeof en]: string } = {
  ...
  onboardingDescription: 'Conecta primero ChatGPT / Codex, o usa una clave API si prefieres otro proveedor de modelos.',
  onboardingCodex: 'Continuar con ChatGPT / Codex',
  onboardingFinishing: 'Preparando PHOENIX…',
  onboardingUseApiKey: 'Usar una clave API',
