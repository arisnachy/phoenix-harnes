/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-model-selection`.
 * @module @phoenix-ai/dsh-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-model-selection'
