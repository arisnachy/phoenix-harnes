...
export const zh = {
  ...
  'effort.selectorAria': '推理等级选择器',
  'effort.sliderAria': '选择推理等级',
  'effort.reset': '恢复默认推理等级',
...
export const en = {
  ...
  'menu.effort': 'Effort',
  'effort.providerDefault': 'Default',
  'effort.selectorAria': 'Reasoning effort selector',
  'effort.sliderAria': 'Select reasoning effort',
  'effort.reset': 'Reset reasoning effort to the provider default',
