/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-runtime`.
 * @module @phoenix-ai/dsh-client-runtime/invariant
 */
...
import type { SlotMap } from '@phoenix-ai/dsh-client-ui-slots'
import type { InvariantInstaller } from '@phoenix-ai/dsh-invariants'

const PACKAGE_NAME = '@phoenix-ai/dsh-client-runtime'
