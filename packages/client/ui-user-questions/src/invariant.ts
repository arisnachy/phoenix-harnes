/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-user-questions`.
 * @module @phoenix-ai/dsh-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-user-questions'
