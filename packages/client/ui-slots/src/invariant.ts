/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-slots`.
 * @module @phoenix-ai/dsh-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-slots'
