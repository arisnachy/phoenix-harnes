/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-plan`.
 * @module @phoenix-ai/dsh-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-plan'
