/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-settings-plugins`.
 * @module @phoenix-ai/dsh-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-settings-plugins'
