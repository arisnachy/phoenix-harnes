...
import * as PluginConfigInvariant from '@phoenix-ai/dsh-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@phoenix-ai/dsh-client-ui-settings-plugins')
