/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-subagent`.
 * @module @phoenix-ai/dsh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-subagent'
