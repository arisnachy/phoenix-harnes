/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-renderer`.
 * @module @phoenix-ai/dsh-client-ui-renderer/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-renderer'
