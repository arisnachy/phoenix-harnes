/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-layout`.
 * @module @phoenix-ai/dsh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-layout'
