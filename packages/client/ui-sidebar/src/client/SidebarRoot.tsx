  ...
  return (
    ...
    >
      <div className={css.logoRow}>
          ...
          >
            <span className={css.brandIdentity} aria-hidden="true">
              <span className={css.brandMark}>
                {renderSlot('sidebar.brand.mark', { size: 28 }, { fallback: <PhoenixLogo size={28} /> })}
              </span>
              <span className={css.brandName}>
                {renderSlot('sidebar.brand.name', {}, {
                  fallback: (
                    <>
                      <span className={css.fallbackBrandName}>PHOENIX</span>
        ...
        {/* Rail resting state is the PHOENIX mark; hovering swaps in the panel
          ...
          >
            {!wide && (
              <span className={css.railMark} aria-hidden="true">
                {renderSlot('sidebar.brand.mark', { size: 24 }, { fallback: <PhoenixLogo size={24} /> })}
              </span>
            )}
