/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-settings`.
 * @module @phoenix-ai/dsh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-settings'
