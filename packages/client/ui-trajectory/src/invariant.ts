/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-trajectory`.
 * @module @phoenix-ai/dsh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-trajectory'
