/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-brand-official`.
 * @module @phoenix-ai/dsh-client-ui-brand-official/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-brand-official'
