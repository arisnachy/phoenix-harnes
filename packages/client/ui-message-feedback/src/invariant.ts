/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-message-feedback`.
 * @module @phoenix-ai/dsh-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-message-feedback'
