/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-attachment`.
 * @module @phoenix-ai/dsh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-attachment'
