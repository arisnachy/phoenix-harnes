...
- **No inline file preview** — arbitrary files are admitted, persisted, submitted, and rendered as metadata cards; opening/downloading their bytes is a separate interaction and does not execute file content in the browser.
