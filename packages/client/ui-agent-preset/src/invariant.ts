/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-agent-preset`.
 * @module @phoenix-ai/dsh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-agent-preset'
