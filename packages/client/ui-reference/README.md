# `@phoenix-ai/dsh-client-ui-reference`
...
Indirectly, through `@phoenix-ai/dsh-file-reference-local` for path guidance and `@phoenix-ai/dsh-session-reference` for prepared session snapshots.
