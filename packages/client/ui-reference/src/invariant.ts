/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-reference`.
 * @module @phoenix-ai/dsh-client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-reference'
