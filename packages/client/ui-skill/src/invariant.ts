/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-skill`.
 * @module @phoenix-ai/dsh-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-skill'
