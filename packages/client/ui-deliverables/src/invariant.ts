/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-deliverables`.
 * @module @phoenix-ai/dsh-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-deliverables'
