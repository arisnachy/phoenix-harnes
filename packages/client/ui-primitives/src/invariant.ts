/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-primitives`.
 * @module @phoenix-ai/dsh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-primitives'
