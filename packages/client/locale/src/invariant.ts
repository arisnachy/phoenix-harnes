/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-locale`.
 * @module @phoenix-ai/dsh-client-locale/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-locale'
