 ...
 */
import type { ClientContext, SnapshotStore } from '@phoenix-ai/dsh-client-runtime/client'
...
/** Registry face used to raise or clear per-session composer blocks. */
export interface ComposerBlocks {
  set(sessionId: import('@phoenix-ai/dsh-client-runtime/client').SessionId, block: ComposerBlock | undefined): void
  storeFor(sessionId: import('@phoenix-ai/dsh-client-runtime/client').SessionId): import('@phoenix-ai/dsh-client-runtime/client').SnapshotStore<ComposerBlock | undefined>
  forget(sessionId: import('@phoenix-ai/dsh-client-runtime/client').SessionId): void
}
