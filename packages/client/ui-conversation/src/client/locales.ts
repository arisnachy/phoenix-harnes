...
export const zh = {
  ...
  'status.preparing': 'Phoenix 正在准备回复',
  'status.searching': 'Phoenix 正在搜索',
  'status.browsing': 'Phoenix 正在浏览',
  'status.reading': 'Phoenix 正在读取',
  'status.writing': 'Phoenix 正在写入',
  'status.executing': 'Phoenix 正在执行',
  'status.runningTools': 'Phoenix 正在使用工具',
  ...
  'file.dropTitle': '将文件拖到此处即可添加',
  'file.dropDesc': '最多 {count} 个文件，每个不超过 {size}',
  'file.tooMany': '一条消息最多添加 {count} 个文件',
  'file.fileTooLarge': '单个文件不能超过 {size}',
  'file.totalTooLarge': '文件总大小超过 {size}，请移除部分文件',
  'file.unsupportedType': '无法读取此文件类型，请选择另一个文件',
  'file.attachmentFallback': '文件附件',
  'file.attachmentMeta': '{mediaType} · {bytes} 字节',
  ...
  'credential.title': '登录网站',
  'credential.description': 'Phoenix 将为此网站填写已识别的登录字段，但不会提交表单。',
  'credential.website': '网站',
  'credential.account': '账号',
  'credential.password': '密码',
  'credential.remember': '保存到 Phoenix Vault，以后自动填写',
  'credential.hint': 'Phoenix 不会提交表单，也不会将凭据保存到对话中。',
  'credential.cancel': '取消',
  'credential.continue': '继续',
  'credential.close': '关闭凭据提示',
  'credential.required': '请输入账号和密码以继续。',
  ...
  'message.contextInternal': '系统内部组件',
  ...
  'reasoning.title': '推理',
  'reasoning.running': 'PHOENIX 正在推理…',
  'reasoning.hidden': '内部推理已隐藏',
  'reasoning.body': '为保护安全与隐私，内部推理不予显示；这里只呈现 PHOENIX 的执行状态。',
  'reasoning.runningA11y': '正在推理',
...
export const en = {
  'status.thinking': 'Phoenix is thinking',
  'status.preparing': 'Phoenix is preparing the response',
  'status.searching': 'Phoenix is searching',
  'status.browsing': 'Phoenix is browsing',
  'status.reading': 'Phoenix is reading',
  'status.writing': 'Phoenix is writing',
  'status.executing': 'Phoenix is executing',
  'status.runningTools': 'Phoenix is using tools',
  'status.verifying': 'Phoenix is verifying the result',
  'view.chat': 'Chat',
  ...
  'file.dropDesc': 'Up to {count} files, {size} each',
  ...
  'file.unsupportedType': 'This file type cannot be read; choose another file',
  'file.attachmentFallback': 'File attachment',
  'file.attachmentMeta': '{mediaType} · {bytes} bytes',
  ...
  'credential.title': 'Sign in to a website',
  'credential.description': 'Phoenix will fill the recognized sign-in fields for this website. It will not submit the form.',
  'credential.website': 'Website',
  'credential.account': 'Account',
  'credential.password': 'Password',
  'credential.remember': 'Save in Phoenix Vault and fill this site next time',
  'credential.hint': 'Phoenix never submits the form or stores the credential in the conversation.',
  'credential.cancel': 'Cancel',
  'credential.continue': 'Continue',
  'credential.close': 'Close credential prompt',
  'credential.required': 'Enter the account and password to continue.',
  'hero.headline': 'PHOENIX',
  ...
  'message.contextInternal': 'System internal',
  ...
  'message.speak': 'Read answer aloud',
  'message.stopSpeaking': 'Stop reading aloud',
  ...
  'reasoning.running': 'PHOENIX is reasoning…',
  'reasoning.hidden': 'Internal reasoning hidden',
  'reasoning.body': 'Internal reasoning is not displayed for safety and privacy; this area shows only PHOENIX execution status.',
  'reasoning.runningA11y': 'Reasoning in progress',
...
export const es = {
  ...
  'status.preparing': 'Phoenix está preparando la respuesta',
  'status.searching': 'Phoenix está buscando',
  'status.browsing': 'Phoenix está navegando',
  'status.reading': 'Phoenix está leyendo',
  'status.writing': 'Phoenix está escribiendo',
  'status.executing': 'Phoenix está ejecutando',
  'status.runningTools': 'Phoenix está usando herramientas',
  'status.verifying': 'Phoenix está verificando el resultado',
  'view.chat': 'Chat',
  ...
  'reasoning.running': 'PHOENIX está razonando…',
  'reasoning.hidden': 'Razonamiento interno oculto',
  'reasoning.body': 'El razonamiento interno no se muestra por seguridad y privacidad; aquí solo verás el estado ejecutivo de PHOENIX.',
  'reasoning.runningA11y': 'Razonamiento en curso',
  'credential.title': 'Iniciar sesión en un sitio web',
  'credential.description': 'Phoenix completará los campos de inicio de sesión reconocidos para este sitio, pero no enviará el formulario.',
  'credential.website': 'Sitio web',
  'credential.account': 'Cuenta',
  'credential.password': 'Contraseña',
  'credential.remember': 'Guardar en Phoenix Vault y rellenar este sitio la próxima vez',
  'credential.hint': 'Phoenix nunca envía el formulario ni guarda la credencial en la conversación.',
  'credential.cancel': 'Cancelar',
  'credential.continue': 'Continuar',
  'credential.close': 'Cerrar aviso de credenciales',
  'credential.required': 'Introduce la cuenta y la contraseña para continuar.',
  'message.contextInjection': 'Inyección de contexto',
  'message.contextRecall': 'Recuerdo de sesión',
  'message.contextInternal': 'Interno del sistema',
