...
export function ChatView({
  ...
  // Hide the optimistic copy as soon as a durable user row from this admission
  // reaches the transcript. Time tolerance avoids an identical older message
  // suppressing the current optimistic bubble.
