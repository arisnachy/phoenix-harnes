/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-conversation`.
 * @module @phoenix-ai/dsh-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-conversation'
