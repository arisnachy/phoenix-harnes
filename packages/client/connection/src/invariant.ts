/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-connection`.
 * @module @phoenix-ai/dsh-client-connection/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-connection'
