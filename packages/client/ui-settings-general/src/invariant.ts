/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-settings-general`.
 * @module @phoenix-ai/dsh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-settings-general'
