 ...
 */
import { IconSettingsOutline14, IconSettingsOutline16 } from '@phoenix-ai/dsh-client-ui-primitives'
import type { PropsLocale, PropsRuntime } from '@phoenix-ai/dsh-client-ui-slots'
import css from './chrome.module.css'

/** Trigger content props: sidebar state plus the standard locale seat. */
...
/**
 * Render the trigger row content (icon + label in the wide column). Feature
 * status belongs in `settings.trigger.trailing`, never inside the shell copy.
