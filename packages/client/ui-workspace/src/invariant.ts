/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-workspace`.
 * @module @phoenix-ai/dsh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-workspace'
