/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-directory-picker-native`.
 * @module @phoenix-ai/dsh-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-directory-picker-native'
