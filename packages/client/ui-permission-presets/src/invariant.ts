/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-permission-presets`.
 * @module @phoenix-ai/dsh-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-permission-presets'
