...
describe('UpdateFooterAction', () => {
  it.each([
    ...
    [{ status: 'paused', phase: 'diverged' }, undefined],
    [{ status: 'paused', phase: 'ahead' }, undefined],
    [{ status: 'paused', phase: 'foreign-remote' }, undefined],
    [{ status: 'paused', phase: 'worktree' }, undefined],
