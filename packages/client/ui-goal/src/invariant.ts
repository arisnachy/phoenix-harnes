/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-goal`.
 * @module @phoenix-ai/dsh-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-goal'
