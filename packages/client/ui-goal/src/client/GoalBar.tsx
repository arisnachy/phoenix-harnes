...
import type { GoalSnapshot } from '@phoenix-ai/dsh-goal/client'
import {
...
export type GoalDockProps = import('@phoenix-ai/dsh-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
