...
import { ConversationEventRegistry } from '@phoenix-ai/dsh-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@phoenix-ai/dsh-goal/client'
