/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-client-ui-theme`.
 * @module @phoenix-ai/dsh-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-client-ui-theme'
