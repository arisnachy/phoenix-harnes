...
import SubagentRuntime, { type SubagentResult, type SubagentRunEndInfo } from '@phoenix-ai/dsh-subagent'
  ...
  it('rejects unknown JSON-RPC runtime methods', async () => {
    ...
    try {
      ...
      await expect(server.handleRequest('does/not/exist', {}))
        .rejects
        .toThrow('unknown PHOENIX SDK runtime method: does/not/exist')
