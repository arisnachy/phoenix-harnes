/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-sdk-jsonrpc-server`.
 * @module @phoenix-ai/dsh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-sdk-jsonrpc-server'
