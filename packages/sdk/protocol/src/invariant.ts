/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-sdk-protocol`.
 * @module @phoenix-ai/dsh-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-sdk-protocol'
