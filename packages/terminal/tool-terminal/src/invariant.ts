/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-tool-terminal`.
 * @module @phoenix-ai/dsh-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-tool-terminal'
