/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-tmux-context`.
 * @module @phoenix-ai/dsh-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-tmux-context'
