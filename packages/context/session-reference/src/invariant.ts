/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-session-reference`.
 * @module @phoenix-ai/dsh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-session-reference'
