 ...
 *
 * @module @phoenix-ai/dsh-agent-instructions/files
 */

import { createReadStream } from 'node:fs'
import { stat } from 'node:fs/promises'
import { dirname, isAbsolute, join, relative, resolve } from 'node:path'
import type { FileSystem, FsInfo, FsTarget, FsVersion } from '@phoenix-ai/dsh-fs'
import { assertNever } from '@phoenix-ai/dsh-llm'
import { dshHomeDisplay } from '@phoenix-ai/dsh-home-paths'
