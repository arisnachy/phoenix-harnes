/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-agent-instructions`.
 * @module @phoenix-ai/dsh-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-agent-instructions'
