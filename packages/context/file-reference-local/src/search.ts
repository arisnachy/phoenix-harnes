 ...
 *
 * @module @phoenix-ai/dsh-file-reference-local/search
 */

import { lstat, readdir } from 'node:fs/promises'
import { isAbsolute, join, relative, resolve, sep } from 'node:path'
import type { FileReferenceCandidate } from '@phoenix-ai/dsh-file-reference'

export { activeAtToken, formatFileMention } from '@phoenix-ai/dsh-file-reference/grammar'
