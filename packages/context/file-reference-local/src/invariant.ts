/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-file-reference-local`.
 * @module @phoenix-ai/dsh-file-reference-local/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-file-reference-local'
