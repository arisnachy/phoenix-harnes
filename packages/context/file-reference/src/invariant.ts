/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-file-reference`.
 * @module @phoenix-ai/dsh-file-reference/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-file-reference'
