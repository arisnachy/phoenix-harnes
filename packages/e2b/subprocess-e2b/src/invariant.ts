/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-subprocess-e2b`.
 * @module @phoenix-ai/dsh-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-subprocess-e2b'
