...
import type { WebSearchProvider, WebSearchResult } from '@phoenix-ai/dsh-web'
...
async function mountTools(opts: {
  ...
  fetchProvider?: import('@phoenix-ai/dsh-web').WebFetchProvider
