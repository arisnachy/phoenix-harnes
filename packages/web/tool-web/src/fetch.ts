...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@phoenix-ai/dsh-tools'
import type { WebFetchBody, WebFetchResult } from '@phoenix-ai/dsh-web'
 ...
 * `@phoenix-ai/dsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@phoenix-ai/dsh-tool-call-timeout-policy` to enforce.
