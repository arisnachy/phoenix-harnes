/**
 * `@phoenix-ai/dsh-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@phoenix-ai/dsh-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@phoenix-ai/dsh-web`.
 *
