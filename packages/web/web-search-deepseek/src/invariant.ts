/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-web-search-deepseek`.
 * @module @phoenix-ai/dsh-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-web-search-deepseek'
