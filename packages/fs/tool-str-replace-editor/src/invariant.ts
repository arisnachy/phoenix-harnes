/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-tool-str-replace-editor`.
 * @module @phoenix-ai/dsh-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-tool-str-replace-editor'
