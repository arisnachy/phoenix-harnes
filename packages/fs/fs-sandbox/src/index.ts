 ...
 * `@phoenix-ai/dsh-fs` Service Definition. It extends `LocalFileSystem` so all
 ...
 * stays `ctx.shell`'s job (`@phoenix-ai/dsh-bash-sandbox`). This mirrors the
 ...
 * escalation retry lives in the tool layer (`@phoenix-ai/dsh-tool-fs`),
 * exactly as bash's does.
 *
 * @module @phoenix-ai/dsh-fs-sandbox
 */

import { Context } from '@phoenix-ai/cordis'
import { LocalFileSystem } from '@phoenix-ai/dsh-fs-local'
import type { Config as LocalConfig } from '@phoenix-ai/dsh-fs-local'
import { FsError } from '@phoenix-ai/dsh-fs'
import type { FsEditOutcome, FsEditRequest, FsTarget, FsVersion, FsWriteIntent, FsWriteOutcome } from '@phoenix-ai/dsh-fs'
import { writableRoots } from '@phoenix-ai/dsh-sandbox'
import type { SandboxExecutionPolicy, SandboxMode } from '@phoenix-ai/dsh-sandbox'
import type {} from '@phoenix-ai/dsh-sandbox-policy'
