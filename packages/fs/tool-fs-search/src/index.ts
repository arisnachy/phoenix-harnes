 ...
 * ({@link module:@phoenix-ai/dsh-tool-fs-search/glob} /
 * {@link module:@phoenix-ai/dsh-tool-fs-search/grep}), result parsing,
...
import { GLOB_TIMEOUT_MS, GREP_TIMEOUT_MS, RAW_OUTPUT_MAX_BYTES, SEARCH_GRACE_MS, SEARCH_META_MAX_BYTES, SEARCH_STDERR_MAX_BYTES } from './search-core.ts'
