/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-tool-fs-search`.
 * @module @phoenix-ai/dsh-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-tool-fs-search'
