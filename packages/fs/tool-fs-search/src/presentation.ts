 ...
 * model-facing render consumes ({@link module:@phoenix-ai/dsh-tool-fs-search/search-core}
 ...
 *
 * @module @phoenix-ai/dsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@phoenix-ai/dsh-tool-fs-search/grep} `formatGrepMatches`), so
