/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-command-feedback`.
 * @module @phoenix-ai/dsh-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-command-feedback'
