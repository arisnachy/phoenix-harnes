...
import * as CommandFeedback from '@phoenix-ai/dsh-command-feedback'
...
describe('/feedback real Loader composition through cordis.yml', () => {
  it('boots cordis.yml and records feedback without model-visible output', async () => {
    ...
    await writeFile(configPath, [
      ...
      "- name: '@phoenix-ai/dsh-commands'",
      "- name: '@phoenix-ai/dsh-command-feedback'",
      '',
    ].join('\n'))
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@phoenix-ai/dsh-commands', CommandRuntime],
      ['@phoenix-ai/dsh-command-feedback', CommandFeedback],
    ])
