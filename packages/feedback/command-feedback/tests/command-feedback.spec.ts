...
import SessionStore, { foldSurface, Session, SessionId } from '@phoenix-ai/dsh-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@phoenix-ai/dsh-session-telemetry'
...
vi.mock('@phoenix-ai/dsh-anonymous-user-id', () => ({
...
describe('@phoenix-ai/dsh-command-feedback registration', () => {
