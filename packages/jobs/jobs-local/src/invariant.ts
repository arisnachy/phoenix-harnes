/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-jobs-local`.
 * @module @phoenix-ai/dsh-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-jobs-local'
...
/**
 * No runtime invariant: `@phoenix-ai/dsh-jobs/invariant` owns per-snapshot identity, status,
