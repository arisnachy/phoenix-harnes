/** Package-owned permission-preset event invariants. @module @phoenix-ai/dsh-permission-presets/invariant */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-permission-presets'
