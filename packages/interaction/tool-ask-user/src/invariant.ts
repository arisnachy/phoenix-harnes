/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-tool-ask-user`.
 * @module @phoenix-ai/dsh-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-tool-ask-user'
