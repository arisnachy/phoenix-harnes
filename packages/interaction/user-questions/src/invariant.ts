/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-user-questions`.
 * @module @phoenix-ai/dsh-user-questions/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-user-questions'
