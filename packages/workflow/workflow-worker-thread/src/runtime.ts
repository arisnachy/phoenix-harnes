 ...
 * @module @phoenix-ai/dsh-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@phoenix-ai/dsh-llm'
import { SessionId } from '@phoenix-ai/dsh-session'
import { assertObjectJsonSchema, JsonSchemaError } from '@phoenix-ai/dsh-tools'
import type { ObjectJsonSchema } from '@phoenix-ai/dsh-tools'
import { isFatalWorkflowError, WorkflowError } from '@phoenix-ai/dsh-workflow'
import type {
