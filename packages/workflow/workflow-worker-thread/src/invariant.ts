/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-workflow-worker-thread`.
 * @module @phoenix-ai/dsh-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-workflow-worker-thread'
