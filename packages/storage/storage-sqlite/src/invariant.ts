/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-storage-sqlite`.
 * @module @phoenix-ai/dsh-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-storage-sqlite'
