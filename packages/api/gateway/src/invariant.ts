/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-api-gateway`.
 * @module @phoenix-ai/dsh-api-gateway/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-api-gateway'
