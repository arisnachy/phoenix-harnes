/** Package-owned invariant companion for the directory-picker seam. @module @phoenix-ai/dsh-host-directory-picker/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@phoenix-ai/dsh-invariants'

const PACKAGE_NAME = '@phoenix-ai/dsh-host-directory-picker'
