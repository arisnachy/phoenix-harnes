 ...
 * @module @phoenix-ai/dsh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@phoenix-ai/dsh-host-directory-picker-native',
  browse: '@phoenix-ai/dsh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@phoenix-ai/dsh-client-ui-directory-picker-native',
  browse: '@phoenix-ai/dsh-client-ui-directory-picker-browse',
}
