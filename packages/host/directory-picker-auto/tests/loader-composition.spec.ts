...
import type { DirectoryPicker } from '@phoenix-ai/dsh-host-directory-picker'
import BrowseDirectoryPicker from '@phoenix-ai/dsh-host-directory-picker-browse'
import NativeDirectoryPicker from '@phoenix-ai/dsh-host-directory-picker-native'
...
const AUTO = '@phoenix-ai/dsh-host-directory-picker-auto'
const NATIVE = '@phoenix-ai/dsh-host-directory-picker-native'
const BROWSE = '@phoenix-ai/dsh-host-directory-picker-browse'
const NATIVE_SURFACE = '@phoenix-ai/dsh-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@phoenix-ai/dsh-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  await writeFile(configPath, [
    "- name: '@phoenix-ai/dsh-host-webserver'",
    '  config:',
    `    host: '${bindHost}'`,
    '    port: 0',
    `- name: '${AUTO}'`,
  ...
  const modules = new Map<string, unknown>([
    ['@phoenix-ai/dsh-host-webserver', HttpServer],
