/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-host-frontend-static`.
 * @module @phoenix-ai/dsh-host-frontend-static/invariant
 */

import type { Context } from '@phoenix-ai/cordis'
import type { InvariantInstaller } from '@phoenix-ai/dsh-invariants'

const PACKAGE_NAME = '@phoenix-ai/dsh-host-frontend-static'
