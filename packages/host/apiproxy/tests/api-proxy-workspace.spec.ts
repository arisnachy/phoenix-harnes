...
import type { Agent, AgentFactory } from '@phoenix-ai/dsh-agent'
...
import type { DirectoryPickerCapability } from '@phoenix-ai/dsh-host-directory-picker'
import WorkspaceRegistry from '@phoenix-ai/dsh-workspace'
import type { HostFrame, WorkspaceId } from '@phoenix-ai/dsh-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@phoenix-ai/dsh-host-apiproxy/api/rpc'
