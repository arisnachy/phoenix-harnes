...
import type { ApprovalOutcome, ApprovalRequestId } from '@phoenix-ai/dsh-user-approval/types'
...
import type { JsonValue, SessionEvent, SessionId } from '@phoenix-ai/dsh-session/types'
import type { ToolCallView, ToolResultView } from '@phoenix-ai/dsh-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@phoenix-ai/dsh-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
