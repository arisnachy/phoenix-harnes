/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-host-apiproxy`.
 * @module @phoenix-ai/dsh-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-host-apiproxy'
