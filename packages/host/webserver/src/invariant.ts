/**
 * Package-owned invariant companion for `@phoenix-ai/dsh-host-webserver`.
 * @module @phoenix-ai/dsh-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@phoenix-ai/dsh-host-webserver'
