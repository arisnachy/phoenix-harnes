...
function checkManifest(
  ...
  if (owner.packageName === '@phoenix-ai/dsh-invariants') return
  if (manifest.peerDependencies?.['@phoenix-ai/dsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@phoenix-ai/dsh-invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@phoenix-ai/dsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@phoenix-ai/dsh-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@phoenix-ai/dsh-invariants'
