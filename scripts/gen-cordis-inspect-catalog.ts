...
import type { CordisCatalogModel, ServiceMethodEntry } from '@phoenix-ai/dsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@phoenix-ai/dsh-tool-cordis/api-catalog', '@phoenix-ai/dsh-cordis-client-runner/client/api-catalog')
