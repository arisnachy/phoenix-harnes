...
import SqliteSessionQueryEngine from '@phoenix-ai/dsh-session-query-sqlite'
import GoalService from '@phoenix-ai/dsh-goal'
import SystemPrompt from '@phoenix-ai/dsh-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@phoenix-ai/dsh-tools'
import LocalBashExecutor from '@phoenix-ai/dsh-bash-local'
import * as BashEnvPlugin from '@phoenix-ai/dsh-shell-env'
import { PwshLocalExecutor } from '@phoenix-ai/dsh-pwsh-local'
...
import * as WebSearchExa from '@phoenix-ai/dsh-web-search-exa'
import * as WebFetchLocal from '@phoenix-ai/dsh-web-fetch-http'
import SubagentRuntime from '@phoenix-ai/dsh-subagent'
import type { SubagentProvider, SubagentReportDelivery } from '@phoenix-ai/dsh-subagent'
import * as ToolSubagentControl from '@phoenix-ai/dsh-tool-subagent-control'
import * as ToolSubagentListAgents from '@phoenix-ai/dsh-tool-subagent-control/list-agents'
import * as ToolSubagentReport from '@phoenix-ai/dsh-tool-subagent-report'
...
import * as ToolBashPersistent from '@phoenix-ai/dsh-tool-bash-persistent'
import * as ToolPwshPersistent from '@phoenix-ai/dsh-tool-pwsh-persistent'
import CordisHostRunner from '@phoenix-ai/dsh-cordis-host-runner'
import * as ToolCordis from '@phoenix-ai/dsh-tool-cordis'
import * as ToolFs from '@phoenix-ai/dsh-tool-fs'
import * as ToolFsSearch from '@phoenix-ai/dsh-tool-fs-search'
import * as ToolStrReplaceEditor from '@phoenix-ai/dsh-tool-str-replace-editor'
...
import VmWorkflowEngine from '@phoenix-ai/dsh-workflow-worker-thread'
import * as ToolRalph from '@phoenix-ai/dsh-tool-ralph'
import * as ToolWorkflow from '@phoenix-ai/dsh-tool-workflow'
...
const TOOL_PACKAGES: ToolPackage[] = [
  {
    pkg: '@phoenix-ai/dsh-tool-ask-user',
    dir: 'tool-ask-user',
  ...
  {
    pkg: '@phoenix-ai/dsh-tool-cordis',
    dir: 'tool-cordis',
  ...
  {
    pkg: '@phoenix-ai/dsh-tool-bash-persistent',
  ...
  {
    pkg: '@phoenix-ai/dsh-tool-pwsh-persistent',
  ...
  {
    pkg: '@phoenix-ai/dsh-tool-str-replace-editor',
  ...
  },
  {
    ...
    note:
      'The read-before-write/edit policy is added by `@phoenix-ai/dsh-fs-observation-policy` (an `fs/*` event-gate plugin, no schema change); a deployment that loads these tools is expected to also load it. The image tool is not registered without `ctx.attachments`; its schema is route-independent, and execution refuses unless the exact routed model declares image input.',
  },
  {
    pkg: '@phoenix-ai/dsh-tool-fs-search',
    dir: 'tool-fs-search',
  ...
  {
    pkg: '@phoenix-ai/dsh-tool-terminal',
    dir: 'tool-terminal',
  ...
  {
    pkg: '@phoenix-ai/dsh-tool-subagent',
    dir: 'tool-subagent',
  ...
  {
    pkg: '@phoenix-ai/dsh-tool-subagent-control',
  ...
  {
    pkg: '@phoenix-ai/dsh-tool-subagent-report',
  ...
  {
    pkg: '@phoenix-ai/dsh-tool-workflow',
    dir: 'tool-workflow',
