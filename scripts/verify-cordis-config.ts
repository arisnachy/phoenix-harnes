...
const CHOOSER_PACKAGE = '@phoenix-ai/dsh-host-directory-picker-auto'
...
const CHOOSER_BACKEND_PACKAGES = [
  '@phoenix-ai/dsh-host-directory-picker-native',
  '@phoenix-ai/dsh-host-directory-picker-browse',
  '@phoenix-ai/dsh-client-ui-directory-picker-browse',
  '@phoenix-ai/dsh-client-ui-directory-picker-native',
]
const errors: string[] = []
...
function validateEntry(value: unknown, file: string, path: string): void {
  ...
  if (value.name !== '@phoenix-ai/cordis-plugin-include') return
