...
function superviseWatcher(host) {
  ...
  if (desktopFastStart) {
    console.error('[PHOENIX DESKTOP] fast-start: deferring update watcher until the Host is responsive.')
...
while (true) {
  ...
  if (desktopFastStart && earlyCrash) {
    console.error('[PHOENIX DESKTOP] fast-start Host exited early; running full recovery preflight before relaunch.')
    recoverConfigurationBeforeFirstBoot()
  }
