...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/core/living': { kind: 'indirect', reason: 'The service contract delegates model-facing policy, schemas, and result rendering to dsh-tool-living.' },
  'packages/core/living-local': { kind: 'indirect', reason: 'The durable local provider delegates model-facing policy, schemas, and result rendering to dsh-tool-living.' },
