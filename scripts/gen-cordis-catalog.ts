...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@phoenix-ai/dsh-typert-generator'
import type { CordisCatalogPolicy } from '@phoenix-ai/dsh-typert-generator'
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  visualWorkspace: 'client-side interface-typed browser service — packages/client/ui-workspace/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  VoiceAnnouncementId: 'extensions.md',
  VoiceAnnouncementReceipt: 'extensions.md',
  VoiceRuntimeStatus: 'extensions.md',
  VoiceImportantEvent: 'extensions.md',
  VoiceSpeechToTextProvider: 'extensions.md',
  VoiceTranscript: 'extensions.md',
  VoiceTranscriptionRequest: 'extensions.md',
  VoiceTextToSpeechProvider: 'extensions.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  CognitiveMemoryHit: 'cognitive memory search result is owned by packages/session/session-learning/README.md',
  CognitiveMemoryInput: 'cognitive memory input is owned by packages/session/session-learning/README.md',
  CognitiveMemoryQuery: 'cognitive memory query is owned by packages/session/session-learning/README.md',
  CognitiveMemoryRecord: 'cognitive memory record is owned by packages/session/session-learning/README.md',
  CognitiveRuntimeConfig: 'cognitive runtime configuration is owned by packages/session/cognitive-runtime/README.md',
  CognitiveState: 'cognitive runtime state is owned by packages/session/cognitive-runtime/README.md',
  ...
  UserProfileConsented: 'profile projection contract is owned by packages/profile/user-profile/src/types.ts',
  AssistantIdentity: 'assistant identity settings contract is owned by packages/profile/user-profile/src/types.ts',
  UserProfileRedacted: 'profile projection contract is owned by packages/profile/user-profile/src/types.ts',
  UserProfileUpdate: 'profile update contract is owned by packages/profile/user-profile/src/types.ts',
  UserProfileView: 'profile service view is owned by packages/profile/user-profile/src/types.ts',
