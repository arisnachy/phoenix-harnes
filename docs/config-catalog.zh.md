...
export interface Config {
  ...
  tools?: ToolsConfig
  /** PHOENIX home directory exposed to bash and used for local skill discovery. */
  dshHome?: string
 ...
 * and one PHOENIX-owned shutdown bound. Uploading modes validate their endpoint
...
export interface Config {
  /** PHOENIX home directory exposed as `DSH_HOME`; defaults to `$DSH_HOME` or `~/.dsh`. */
  dshHome?: string
}
```
...
export interface Config {
  ...
  /** PHOENIX config root. Defaults to `$DSH_HOME` or `~/.dsh`. */
  dshHome?: string
...
来源：[`packages/subagent/tool-subagent/src/index.ts:35`](../packages/subagent/tool-subagent/src/index.ts)
...
来源：[`packages/web/web-search-free/src/index.ts:13`](../packages/web/web-search-free/src/index.ts)
...
来源：[`packages/web/web-search-openrouter/src/index.ts:38`](../packages/web/web-search-openrouter/src/index.ts)
...
- `@deepseek-ai/dsh-user-profile` — 需要 `settings` · `systemPrompt`（[`packages/profile/user-profile/src/index.ts`](../packages/profile/user-profile/src/index.ts)）
