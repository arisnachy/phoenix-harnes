...
import type {} from '@phoenix-ai/dsh-client-ui-settings-plugins/client'
...
```jsonc
{
  ...
  "dsh": { "client": { "platform": "web", "inject": ["@phoenix-ai/dsh-client-ui-settings-plugins"] } }
}
```
...
export default clientBundle('@phoenix-ai/dsh-client-my-plugin', ['lib/types/index.js', 'lib/types/invariant.js'])
```
