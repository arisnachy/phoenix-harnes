...
| [living.md](living.md) | Phoenix's universal operational relationship with created systems: durable manifests, integration levels, live state, events, actions, actors, and reconnectable control transport |
