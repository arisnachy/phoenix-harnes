...
- **Green tests are evidence, never proof.** Follow [adversarial completion verification](.agents/notes/implemented/process/2026-09-20-adversarial-completion-verification.md) before claiming completion.
