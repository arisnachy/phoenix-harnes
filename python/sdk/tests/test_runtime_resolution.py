...
def test_default_config_is_shipped_with_the_package() -> None:
    ...
    assert "@phoenix-ai/dsh-agent-spine-demo" in config
    assert "@phoenix-ai/dsh-session-persistence-jsonl" in config
    assert "@phoenix-ai/dsh-session-checkpoint-policy" in config
