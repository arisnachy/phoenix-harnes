...
- `packages/*` (except agent-loop's own tests and examples/) must not import `@phoenix-ai/dsh-agent-loop`.
- No cross-package deep imports (`@phoenix-ai/dsh-*/src/...` paths) — public entry points only.
