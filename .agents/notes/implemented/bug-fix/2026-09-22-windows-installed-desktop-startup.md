...
The desktop assembly and Inno Setup metadata use version `1.0.21`, the next Windows release after `windows-v1.0.20`. The [installer contract test](../../../../scripts/windows-installer.spec.ts) keeps both version values synchronized.
